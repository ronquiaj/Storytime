...
export default function SignupForm(props) {
    const { changeAlert, handleClick, emailRef, changeEmailRef, passwordRef, changePasswordRef, passwordConfirmationRef, changePasswordConfirmationRef, displayNameRef, changeDisplayNameRef, handleChange, alert} = props;
    return (
